...
import com.mts2792.launcher.provider.RestoreDbTask;
import com.mts2792.launcher.util.ManagedProfileHeuristic;
import com.mts2792.launcher.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (Binder.getCallingPid() != Process.myPid()
            ...
            widgetSelection = String.format(Locale.ENGLISH, "%1$s = %2$d AND ( %3$s )",
                    LauncherSettings.Favorites.ITEM_TYPE, LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET, widgetSelection);
            try (Cursor c = db.query(LauncherSettings.Favorites.TABLE_NAME, new String[] { LauncherSettings.Favorites.APPWIDGET_ID },
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements AutoInstallsLayout.LayoutParserCallback {
        ...
        public void checkId(String table, ContentValues values) {
            ...
            if (table == LauncherSettings.WorkspaceScreens.TABLE_NAME) {
